...
function Show-Finding {
    ...
    # Using basic ASCII symbols for maximum compatibility
    $symbols = @{
...
try {
    # Display header
    Show-Header -Title "AMAZE Prefetch Analyzer v1.2"
    Write-Host "Version 1.2 | $(Get-Date -Format 'yyyy-MM-dd HH:mm:ss')" -ForegroundColor DarkGray
    Write-Host "Analyzing Windows Prefetch files (factual analysis only)" -ForegroundColor Gray
    Write-Host ""
